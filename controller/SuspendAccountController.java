    ...
    public void submit() {
        switch (checking()) {
            ...
            case 1:
                ...
                break;
            case 2:
                AlertController.errorAlert("Invalid", "Invalid Operation", "This account has already been suspended!!");
                break;
            case 3:
                BankController.suspendAccount(anTF.getText());
                db.dbWrite();
                AlertController.informationAlert("Success", "Success", "Account " + anTF.getText() + " has been suspended.");
